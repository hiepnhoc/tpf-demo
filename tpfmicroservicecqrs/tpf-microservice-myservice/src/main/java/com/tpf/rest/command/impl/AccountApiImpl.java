package com.tpf.rest.command.impl;
...
import com.tpf.command.AccountCommandFactory;
import com.tpf.rest.command.AccountCommandApi;
...
public class AccountApiImpl implements AccountCommandApi {
    ...
    public CompletableFuture<String> createAccount(AccountOwner user) {
        ...
        Assert.hasLength(user.getUsername(), "Missing account username");
        Assert.hasLength(user.getPassword(), "Missing account password");
        String accountId = UUID.randomUUID().toString();
        CompletableFuture<String> completableFuture = CompletableFuture.supplyAsync(() ->
                commandGateway.sendAndWait(commandFactory.newCreateAccountCommand(accountId, user.getName(), user.getUsername(), user.getPassword()))
        );
